...
@MapperScan(basePackages = {"com.nbteam.hislite.lhrm.*.*.mapper"}, sqlSessionTemplateRef = "hisliteSqlSessionTemplate")
public class HisliteMybatisConfig {
    ...
    public SqlSessionFactory sqlSessionFactory(@Qualifier("hisliteDataSource") DataSource hisliteDataSource) throws Exception {
        ...
        factoryBean.setMapperLocations(resolver.getResources("classpath*:com/nbteam/hislite/lhrm/**/mybatis/*Mapper.xml"));//指定xml文件位置
