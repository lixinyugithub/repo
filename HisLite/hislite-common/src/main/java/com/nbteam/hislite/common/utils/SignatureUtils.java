...
public class SignatureUtils {
	...
	public static String rsa256Sign(Map<String, String> paramsMap) {
		...
		//加签
		return SignatureUtils.rsa256Sign(sortContent, ygkzPrivateKey);
	 ...
	 * @return
	 */
	public static String getSortContentO(Map<String, Object> paramsMap) {
		StringBuffer content = new StringBuffer();
		List<String> keys = new ArrayList<>(paramsMap.keySet());
		Collections.sort(keys);
		int index = 0;
	...
	public static String buildSortJson(Map<String, String> dataMap) {
		...
		for (String jsonKey : jsonKeys) {
			if (sortSb.length() > 0) {
				sortSb.append(STRING_AND_CHAR);
			}
			sortSb.append(jsonKey).append(STRING_ASSIGN_CHAR).append(dataMap.get(jsonKey));
		}
