...
public class JsonXmlUtils {
	...
	/**
	 * json转map<String,Object> <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param jsonStr
	 * @return
	...
	/**
	 * json转map<String,String> <请替换成功能描述> <br>
	 * <请替换成详细描述>
	 * 
	 * @param jsonStr
	 * @return
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static Map<String, Object> xmlToMap(String xml, String xpath) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	private static Map<String, Object> eleTomap(Element rootElt) {
		Map<String, Object> map = new HashMap<String, Object>();
