package com.nbteam.hislite.his.api.outpatient.dto;
 ...
 * @author 
 */
public class HisOppayOrder implements Serializable {
    @ApiModelProperty("门诊缴费id号")
    private Long oppayOrderId;
    ...
    public Long getOppayOrderId() {
        return oppayOrderId;
    }

    public void setOppayOrderId(Long oppayOrderId) {
        this.oppayOrderId = oppayOrderId;
    }
